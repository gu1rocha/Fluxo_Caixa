...
window.addEventListener('mouseup',function(e){
    ...
    if (!(e.target == document.querySelector('.box_compra') || document.querySelector('.box_compra').contains(e.target)) && !document.querySelector('.back_box_compra').classList.value.includes('hidden')) 
    {
        document.querySelector('.back_box_compra').classList.add('hidden');
    }
});